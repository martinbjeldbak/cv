...
\begin{entrylist}
  \entry%
    ...
    I am responsible for designing, implementing, \& maintaining infrastructure, microservices, DevSecOps pipelines, mainly using GitHub Actions and Golang. I work with architects, tech leads, and security team members to deliver features that support the bank across a multitude of areas. Since starting, I have worked in two core teams.}
  \entry%
    {2016--2020}
...
\begin{entrylist}
  ...
  \entry%
    {since 2022}
    {Self-hosted}
    {\github{martinbjeldbak/self-hosted}}
    {Open-sourced my local docker-compose configuration running on my home server.}
  \entry%
    {2016}
